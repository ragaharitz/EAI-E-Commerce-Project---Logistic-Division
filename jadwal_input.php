...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container" id="input">
        <div class="row">
            <div class="col-md-6">
                <form action="process/insert_jadwal.php" method="post">
                    <div class="form-group">
                        <label>ID Jadwal</label>
                        <input type="text" name="id_jadwal" required class="form-control" placeholder="Contoh: SCH001"/>
                    </div>
                    <div class="form-group">
                        <label>ID Pengiriman </label>
                        <input type="text" name="id_pengiriman" required class="form-control" placeholder="Contoh: SND001"/>
                    </div>
                    <div class="form-group">
                        <label>Tanggal</label>
            ...
            <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_pengirim" required class="form-control" placeholder="Contoh: Xiaomi"/>
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                        <input type="text" name="alamat" required class="form-control" placeholder="Contoh: Jl. Buah Batu No. 01"/>
                    </div>
                    <div class="form-group">
                        <label>Nama Penerima</label>
                        <input type="text" name="nama_penerima" required class="form-control" placeholder="Contoh: Tomi"/>
                    </div>
